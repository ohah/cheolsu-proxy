...
impl App {
    ...
    async fn handle_breakpoint_key(&mut self, key: KeyEvent) {
        match key.code {
            // Switch focus between rules and pending
            KeyCode::Left | KeyCode::Right => {
    ...
    async fn handle_bp_add_form_key(&mut self, key: KeyEvent) {
