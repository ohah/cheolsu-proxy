...
- **Branch/PR link** (optional): User may provide the link (e.g. `https://github.com/ohah/cheolsu-proxy/pull/123`). If not provided, use GitHub CLI to find the PR for the **current branch**:
  ```bash
