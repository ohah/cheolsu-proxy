...
use proxy_v2::{
    ...
    remove_tls_passthrough, replay_request, replay_sequence, resolve_breakpoint, save_session,
    start_proxy_v2, stop_proxy_v2, toggle_contract_spec, uninstall_ca_cert, uninstall_cli,
    unload_contract_spec, unload_script, update_breakpoint_rules, update_client_certificate,
    update_connection_strategy, update_default_passthrough_domains, update_host_mappings,
