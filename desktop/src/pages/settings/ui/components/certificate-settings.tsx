...
function RemoteDeviceCertSection() {
  const { t } = useLingui();
              ...
              {showIosGuide && (
                ...
                >
                  <ol className="list-decimal list-inside space-y-1">
                    ...
                    <li>
                      <Trans>Tap "Allow" when prompted to download the configuration profile</Trans>
                    </li>
                    <li>
                      <Trans>
