/**
 * Cheolsu Proxy - TypeScript/JavaScript 스크립팅 API 타입 정의
 *
 * 사용법:
 *   1. 이 파일을 프로젝트에 복사하거나 참조합니다.
 *   2. tsconfig.json에 다음을 추가합니다:
 *      { "compilerOptions": { "types": ["./cheolsu"] } }
 *   3. 스크립트에서 cheolsu.onRequest(), cheolsu.onResponse() 등을 사용합니다.
 */
